...
**La taxonomía que destrabó el grafo.** Un Haiku diagnosticó el canario de inmediato y bien (`transcripts/05`): prompt sin piso mínimo de exploración, presupuesto de búsqueda no declarado, y propuso buscar más — piso, dos fases. Era una solución coherente al problema planteado. Romina no la descartó; la dejó para el harness y cambió la pregunta, porque buscar más no es buscar mejor: le pidió a otro Haiku que leyera una muestra de 20 avisos y dijera cuál era la estructura taxonómica subyacente al lenguaje, para que el grafo fuera más rico y no solo más recorrido. Respuesta en cuatro mensajes (`transcripts/07`): tres niveles —
